...
while True:
    try:
        ...
        print("Não há nem um item errado na lista.") if itens_errados == 0 else print(f"Há {itens_errados} ite{plural} errado{plural} na lista.")

        while True:
            try:
                continuar = input("Você quer continuar? (y / n) ").strip().lower()
                ...
                print("\033[1;37;41m[Valor invalido]\033[m Digite \"y\" (yes) ou \"n\" (Não).")
